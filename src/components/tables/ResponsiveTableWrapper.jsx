            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex-1 min-w-0">
                ...
                {columns.slice(0, 2).map((col) => (
                  <div key={col.key} className="text-xs text-gray-600">
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                {columns.slice(0, 4).map((col) => (
                  <div key={col.key}>
                    <p className="text-xs sm:text-sm font-medium text-gray-700 mb-1">{col.label}</p>
          ...
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              {columns.map((col) => (
                <th
                  key={col.key}
                  className="px-4 py-3 text-left text-xs sm:text-sm font-medium text-gray-700"
