...
/**
 * Get list of provinces that have active shipping zones configured
 * Used by RecipientSelector and address forms to show only deliverable provinces
 * @returns {Object} {success, provinces, error}
 */
