...
CREATE INDEX idx_user_categories_category ON public.user_categories(category_name);
CREATE INDEX idx_user_categories_assigned_by ON public.user_categories(assigned_by);
...
-- Indexes
CREATE INDEX idx_user_category_history_user_id ON public.user_category_history(user_id);
CREATE INDEX idx_user_category_history_changed_at ON public.user_category_history(changed_at);
CREATE INDEX idx_user_category_history_changed_by ON public.user_category_history(changed_by);
...
-- Check default discounts
SELECT * FROM public.category_discounts;
